...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/"
			...
			switch elem[0] {
			case 'a': // Prefix: "auth/google"

				if l := len("auth/google"); len(elem) >= l && elem[0:l] == "auth/google" {
					elem = elem[l:]
				} else {
					break
				}
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "POST":
						s.handleAuthWithGoogleRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/status"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "PATCH":
								s.handleUpdateTaskStatusRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "auth/google"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "POST":
						r.name = AuthWithGoogleOperation
						r.summary = ""
						r.operationID = "authWithGoogle"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/status"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "PATCH":
								r.name = UpdateTaskStatusOperation
								r.summary = ""
								r.operationID = "updateTaskStatus"
								r.operationGroup = ""
